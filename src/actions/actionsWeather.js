        ...
        const data = {
          main: {
            ...
            daily: {
              ...
              uvIndexMax: daily.variables(7).valuesArray()|| defaultArr,
              uvIndexClearSkyMax: daily.variables(8).valuesArray() || defaultArr,
              ...
              windSpeedMax: daily.variables(15).valuesArray() || defaultArr,
